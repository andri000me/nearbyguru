        ...
        <tbody>
            <tr>
                ...
                <td> 
                    ...
                    <a class="btn btn-danger btn-xs" onclick="return doconfirm();" href="<?= $this->config->base_url('/index.php/admin/kelas/delete') ?>/<?= $m['id_kelas'] ?>"><i class="fa fa-trash-o "></i>HAPUS</a>
